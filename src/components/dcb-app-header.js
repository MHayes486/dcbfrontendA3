      ...
      return html`
        ...
        <header class="app-header">
          ...
          <nav class="app-top-nav">
            ...
            ${this.user.accessLevel == 2
              ? html` <a href="/newAppointment" @click="${anchorRoute}"
                  >Add Appointments</a
                >`
              : html``}
            ${this.user.accessLevel == 2
              ? html` <a href="/appointments" @click="${anchorRoute}"
        ...
        <sl-drawer class="app-side-menu" placement="left">
          ...
          <nav class="app-side-menu-items">
            ...
            ${this.user.accessLevel == 2
              ? html` <a href="/newAppointment" @click="${this.menuClick}"
                  >Add Appointments</a
                >`
              : html``}
            ${this.user.accessLevel == 2
            ...
            ${this.user.accessLevel == 1
              ? html` <a href="/aboutUs" @click="${this.menuClick}"
                  >About Us & our Team</a
                >`
              : html``}
            ${this.user.accessLevel == 1
              ? html` <a href="/bookAppointment" @click="${this.menuClick}"
